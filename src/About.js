...
const About = () => {
  const stats = [
    { number: "200+", label: "Projects Delivered", icon: <FaChartLine /> },
    { number: "50+", label: "Enterprise Partners", icon: <FaUsers /> },
    { number: "20+", label: "Years Experience", icon: <FaAward /> },
    { number: "99.99%", label: "Client Satisfaction", icon: <FaBullseye /> },
  ];
          ...
          >
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl text-blue-400 mb-2 flex justify-center">
                  {stat.icon}
                </div>
            ...
            >
              <center>
                <div className="items-center">
                  <p className="text-xl text-gray-300 leading-relaxed mb-8">
                    ...
                    transforming businesses through innovative AI and enterprise
              ...
              <div className="grid grid-cols-1 gap-4">
                {whoWeArePoints.map((point, index) => (
                  <div
                    key={index}
                    className="flex items-center p-4 bg-gray-800/50 rounded-lg border-l-4 border-blue-400"
                  >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                We envision to deliver results-driven brand marketing campaigns
                and public relations activities that boost our customers'
                visibility, income, and development.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2" data-aos="fade-left">
              {whatsetsapart.map((point, index) => (
                <div
                  key={index}
                  className="flex items-start p-6 bg-gradient-to-r from-gray-800/50 to-slate-800/50 rounded-xl border-l-4 border-cyan-400"
                >
